    ...
    function kleo_switch_layout( $layout = false, $priority = 10 )
    {
        ...
        switch ( $layout ) {
            ...
            case 'left':
                ...
                add_filter( 'kleo_main_section_class', function($classes) { $classes["tpl"]="tpl-left-sidebar"; return $classes;}, $priority );
                break;

            case 'right':
                add_action( 'kleo_after_content', 'kleo_sidebar', $priority );
                add_filter( 'kleo_main_section_class', function($classes){ $classes["tpl"]="tpl-right-sidebar"; return $classes;}, $priority );
                break;

            case 'full':
            default :
                remove_action( 'kleo_after_content', 'kleo_sidebar' );
                add_filter( 'kleo_main_section_class', function($classes){ $classes["tpl"]="tpl-full-width"; return $classes;}, $priority );
